...
(function () {
    //Fvar MODELS_PATH = "http://192.168.2.17/VoxelPaint/models/";
    Script.include('/~/system/libraries/utils.js');
    Script.include(Script.resolvePath('voxel-paint-shared.js?' + Date.now()));
    ...
    this.addPlatform = function (name) {
        ...
        return Entities.addEntity({
            ...
            modelURL: MODELS_PATH + "studioFloor.fbx?" + Date.now(),
            type: 'Model',
    ...
    this.addAether = function (name, platformID) {
        ...
        return Entities.addEntity({
            ...
            collisionless: true,
            visible: false,
            script: Script.resolvePath('voxel-paint-aether.js?'+ Date.now()),
            userData: JSON.stringify({ grabbableKey: {grabbable: false} })
        });
    };
    ...
    this.addPaletteSpawner = function(position) {
        ...
        var paletteSpawnerID = Entities.addEntity({
            ...
            script: Script.resolvePath('handyAttacher.js?'+ Date.now()),
            type: 'Sphere',
            collidesWith: '',
            collisionMask: 0,
            collisionless: true,
        ...
        Entities.addEntity({
            ...
            modelURL: MODELS_PATH + 'painter_Palette.fbx?'+ Date.now(),
